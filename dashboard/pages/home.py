...
def _outdoor_card(outdoor: dict, suitability: str) -> None:
    ...
    st.markdown(
        ...
        f'<span style="color:#445566;font-size:0.8rem;">Conditions</span>'
        f'<span style="color:#AAAACC;font-weight:600;">{o_desc}</span></div>'
        f'<div style="display:flex;justify-content:space-between;padding:4px 0;">'
        f'<span style="color:#445566;font-size:0.8rem;">Temperature</span>'
        f'<span style="color:#88CCFF;font-weight:600;">{temp_str}</span></div>'
        f'<div style="display:flex;justify-content:space-between;padding:4px 0;'
        f'border-bottom:1px solid #0F1A28;margin-bottom:10px;">'
        f'<span style="color:#445566;font-size:0.8rem;">Humidity</span>'
